...
# Verified on this machine: article + these packages compiles a document with
# inline/display maths, an align environment, a booktabs table, a TikZ diagram and
...
\newenvironment{sourcequote}
  {\begin{quote}\itshape}
  {\end{quote}}
\newcommand{\srcfig}[2]{\begin{figure}[h]\centering
...
_TABULAR_ENV_NAMES = {
    "tabular", "tabular*", "array", "matrix", "pmatrix", "bmatrix", "vmatrix",
    "cases", "split", "aligned",
}

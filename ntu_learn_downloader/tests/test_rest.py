...
class TestRest(unittest.TestCase):
    def test_todo_items_are_course_scoped_and_normalized(self):
        ...
        with patch("ntu_learn_downloader.rest._SESSION.get", calendar_get):
    ...
    def test_get_courses_defaults_to_favourites(self):
        with patch("ntu_learn_downloader.rest._SESSION.get", fake_get):
            self.assertEqual(
    ...
    def test_favourite_query_param_is_sent(self):
        ...
        with patch("ntu_learn_downloader.rest._SESSION.get", capture):
    ...
    def test_rows_not_flagged_favourite_are_dropped(self):
        ...
        with patch("ntu_learn_downloader.rest._SESSION.get",
    ...
    def test_paging_is_followed(self):
        ...
        with patch("ntu_learn_downloader.rest._SESSION.get", paging_get):
            self.assertEqual(
    ...
    def test_401_raises_rest_unavailable(self):
        ...
        with patch("ntu_learn_downloader.rest._SESSION.get", unauthorized):
...
class TestDuplicateNames(unittest.TestCase):
    ...
    def _doc(self, name, link):
        from ntu_learn_downloader.models import Doc

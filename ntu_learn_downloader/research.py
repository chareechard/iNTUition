...
from ntu_learn_downloader import materials
...
def research(item: Dict, courses: Optional[List[str]] = None,
    ...
    if chosen is None:
        raise ResearchError(
            ...
            "ntu_learn_downloader.research_run --setup")
    ...
    if client is None:
        ...
        if not key and not configured():
            raise ResearchError(
                ...
                "ntu_learn_downloader.research_run --setup".format(key_path()))
        try:
            ...
            raise ResearchError(
                ...
                "ntu_learn_downloader.research_run --setup".format(e))

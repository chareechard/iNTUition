"""Import a class schedule for the Temporal Protocol panel.
    ...
    python -m ntu_learn_downloader.schedule_import --download_to NTU

    # or from a file, including an .ics export
    python -m ntu_learn_downloader.schedule_import --file timetable.txt
...
def main():
    ...
    parser.add_argument("--download_to", default="NTU",
                        help="Folder whose .ntu_learn_downloader/ holds the schedule")

"""Triage NTU mail from the command line.
    ...
    python -m ntu_learn_downloader.triage_run --setup
    python -m ntu_learn_downloader.triage_run --login
    python -m ntu_learn_downloader.triage_run --scan
    python -m ntu_learn_downloader.triage_run --scan --since 2026-07-01 --all
    python -m ntu_learn_downloader.triage_run --list
    python -m ntu_learn_downloader.triage_run --done <email_id>
    python -m ntu_learn_downloader.triage_run --import_from ../J.A.R.V.I.S/cerberus
...
from ntu_learn_downloader import academic_calendar, owa, semester, triage, triage_store
...
def main():
    ...
    parser.add_argument("--download_to", default="NTU",
                        help="Folder whose .ntu_learn_downloader/ holds the store")
